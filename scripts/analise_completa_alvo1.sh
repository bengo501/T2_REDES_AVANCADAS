...
# uso: ./analise_completa_alvo1.sh <ip_do_alvo>

if [ -z "$1" ]; then
    echo "uso: $0 <ip_do_alvo>"
    echo "exemplo: $0 192.168.1.105"
    exit 1
fi
...
echo "  - etapa 1: resultados/alvo1/etapa1/"
echo "  - etapa 2: resultados/alvo1/etapa2/"
echo ""
echo "próximos passos:"
echo "1. analisar resultados:"
echo "   grep 'open' resultados/alvo1/etapa2/scan_completo_$TIMESTAMP.txt"
